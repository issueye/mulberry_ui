<template>
  <div class="flex items-center bg-indigo-700 text-light-50 fixed top-0 left-0 right-0"
    ...
    <span class="w-[250px] flex justify-center items-center text-xl font-thin text-white">
      <el-icon class="mr-1">
        <component :is="global.APP_ICON"></component>
      </el-icon>
      {{ global.APP_NAME }} {{ global.APP_VERSION }}
    </span>

    <!-- 这段代码实现了点击图标切换侧边栏宽度的功能，并根据宽度状态切换不同的图标： -->
    <el-icon class="w-[42px] flex justify-center items-center text-xl font-thin text-white hover:bg-indigo-600"
    ...
    <div class="ml-auto flex items-center">
      <el-tooltip effect="dark" content="全屏" placement="bottom">
        <el-icon class="w-[42px] flex justify-center items-center text-xl font-thin text-white hover:bg-indigo-600 mr-1"
